                ...
                <Row>
                    ...
                    <Col xs={12} md={4}>
                        <div className='footer-section'>
                            <h2>Socials Media</h2>
                            <div>
                                <Link className='d-block footer-link' href="/"><i className="fab fa-facebook-square icon-color me-2"></i> Like our Facebook page</Link>
                                <Link className='d-block footer-link' href="/"><i className="fab fa-youtube-square icon-color me-2"></i> Subscribe our YouTube chanel</Link>
                                <Link className='d-block footer-link' href="/"><i className="fab fa-instagram icon-color me-2"></i> Follow on Instagram</Link>
                            </div>
                        </div>
                    </Col>
                </Row>
